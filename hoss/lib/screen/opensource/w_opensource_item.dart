...
import 'package:hoss/screen/opensource/vo_package.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(color: context.appColors.scrollableItem, border: Border.all(color: context.appColors.divider), borderRadius: BorderRadius.circular(4)),
